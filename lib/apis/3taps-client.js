 ...
 * @class The Search API allows clients to query 3taps for data, and data about data.
	 ...
	 *		<td>price</td>
	 *		<td>STRING</td>
	 *		<td>Postings must have this price to be fond/processed. The price field supports <a href="#ranged-values">ranged values</a>.</td>
	 *	</tr>	
	 *	<tr>
	 *		<td>start</td>
	 *		<td>DATE</td>
	 ...
	 *</table>	
	 *
	 *Many of the Common Search Criteria parameters refer to values in the <a href="/method/posting/#posting-model">Posting Object</a>.
	 *
	 *<a name="#ranged-values" />
...
threeTapsSearchClient.prototype = {
	 ...
	 * @param {STRING} retvals A comma-separated list of the fields to return for each posting that matches the given search criteria. A list of available fields can be found in the <a href="/method/posting#posting-model">posting object</a>. Default retvals are category, location, heading, externalURL, and timestamp.
	 ...
	 * </tr>
	 * <tr>
	 *	<td>results</td><td>ARRAY</td><td>An array of <a href="/method/posting#posting-object">posting objects</a>, each containing the fields specified in retvals</td>
	 * </tr>
	 * </table>
	 *
...
threeTapsStatusClient.prototype = {
	 ...
	 *     </tr>
	 *     <tr>
	 *         <td>attributes</td><td>OBJECT</td><td>An object containing name/value pairs of attributes to associate with this status. (ex: postKey, errors)</td><td>optional</td>
	 *     </tr>
	 * </table>
	 * @param
...
threeTapsNotificationsClient.prototype = {
	 ...
	 * @desc Creates an XMPP firehose.  A variant of create(). Supports the use of <a href="/search#search-params">Common Search Criteria</a>.
   ...
   *
   * Subscriptions need one delivery param (email, jid, token) and at least one <a href="/search/#search-params">Common Search Criteria</a> parameter.
   *
