...
threeTapsPostingClient.prototype = {
   ...
   *		 "error": "Heading cannot be null"
	 ...
	 * 
	 * @example
	 * var ids = [{source:"E_BAY",externalID:220721553191},{source:"CRAIG",externalID:191},{source:"AMZON",externalID:370468535518}]
	...
	exists: function(ids, callback) {
		...
		return this.client.request(this.path, 'ids', null, params, function(results) {
			callback(results);
		});
	},
	 ...
	 * @example {String}
	 * { 
	 *   "fields": "[\"source\",\"category\",\"location\",\"latitude\",\"longitude\",\"heading\",\"body\",\"image\",\"externalURL\",\"userID\",\"accountName\",\"timestamp\",\"currency\",\"price\",\"expiration\",\"externalID\",\"contextualTags\",\"language\",\"annotations\",\"trustedAnnotations\"]", 
   ...
   *   "price":0.99,
   *   "currency":null,
   *   "image":["url","http://thumbs1.ebaystatic.com/pict/1505272809088080_1.jpg"],
   ...
   *   "annotations":"{\"post\":{\"tags\":[\"#eBay\",\"#forsale\",\"#jewelry\",\"#HKG\"],\"ship_to_locations\":{\"0\":\"Worldwide\"}}}",
   *   "trustedAnnotations":"{\"post\":{\"tags\":[\"#eBay\",\"#forsale\",\"#jewelry\",\"#HKG\"],\"ship_to_locations\":{\"0\":\"Worldwide\"}}}",
   ...
   *   "comments":[]
	 ...
	 * threeTapsPostingClient.create(JSON.stringify(data), callback);
	 */
...
threeTapsSearchClient.prototype = {
	 ...
	 * @desc Returns the number of items matching a given search. Note that this method accepts the same general parameters as the search method.

	 * @param {String} source See <a href="#methods.search.search">search</a> method.
	 * @param {String} category See <a href="#methods.search.search">search</a> method.
	 * @param {String} location See <a href="#methods.search.search">search</a> method.
	 * @param {String} heading See <a href="#methods.search.search">search</a> method.
	 * @param {String} body See <a href="#methods.search.search">search</a> method.
	 * @param {String} text See <a href="#methods.search.search">search</a> method.
	 * @param {String} poster See <a href="#methods.search.search">search</a> method.
	 * @param {String} externalID See <a href="#methods.search.search">search</a> method.
	 * @param {String} annotations See <a href="#methods.search.search">search</a> method.
	 * @param {String} trustedAnnotations See <a href="#methods.search.search">search</a> method.

	 * @return {Number} The number of matches found for the given parameters.
	 ...
	 */
	'best-match': function(params, callback) {
