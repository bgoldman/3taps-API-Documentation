...
threeTapsPostingClient.prototype = {
	 ...
	 * @example {String}
	 * { "fields": "[\"source\",\"category\",\"location\",\"latitude\",\"longitude\",\"heading\",\"body\",\"image\",\"externalURL\",\"userID\",\"accountName\",\"timestamp\",\"currency\",\"price\",\"expiration\",\"externalID\",\"contextualTags\",\"language\",\"annotations\",\"trustedAnnotations\"]", "post": "[\"e_bay\",\"SAPP\",\"GBR\",54,-4,\"BNWT FRANK USHER ELEGANT LONG BLACK COCKTAIL DRESS sz12\",\"\",\"http://galleryplus.ebayimg.com/ws/web/300516584005_1_0_1.jpg\",\"http://cgi.ebay.com/BNWT-FRANK-USHER-ELEGANT-LONG-BLACK-COCKTAIL-DRESS-sz12-/300516584005?pt=Women_s_Clothing\",\"\",\"milly-jo\",\"20110118195058\",\"USD\",75,\"20110303195058\",\"300516584005\",[],\"EN\",\"{\\\"post\\\":{\\\"ship_to_locations\\\":{\\\"0\\\":\\\"Worldwide\\\"}}}\",\"{\\\"post\\\":{\\\"ship_to_locations\\\":{\\\"0\\\":\\\"Worldwide\\\"}}}\"]", "errors": [ "externalID must be unique for this source" ] }
	 
	 * @example
	 * threeTapsPostingClient.error('66L3B9', callback);
	 */
...
threeTapsSearchClient.prototype = {
	 ...
	 * @param {String} category The 4-character category code a posting must have if it is to be included in the list of search results.
	 * @param {String} location The 3-character location code a posting must have if it is to be included in the list of search results.
