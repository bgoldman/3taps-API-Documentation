 ...
 */
	 ...
	 * @restStructure GET /status/error/[postKey]
	 * @restUrlExample http://3taps.net/status/error/X7J67W

	 * @desc Returns errors found when trying to process the given posting. This method is <strong>DEPRECATED</strong>.
	 ...
	 * @example
	 * threeTapsStatusClient.error('BDY9VCA', callback);
	 */
	 ...
	 * @restStructure POST /status/exists

	 * @desc Returns information on the existence of postings. Note that this method is <strong>DEPRECATED</strong>.
   ...
   *		 "error": "Heading cannot be null"
	 ...
	 * ];
	 * threeTapsStatusClient.exists(JSON.stringify(ids), callback);
	 */
