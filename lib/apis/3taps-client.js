...
threeTapsPostingClient.prototype = {
	 ...
	 * <td><td>postKey</td><td>String</td><td>The postKey of the post.</td></tr>
	 * <td><td>indexed</td><td>String</td><td>The date that the postKey was indexed by 3taps will be here.</td></tr>
	 * </table>
	 * 
	 ...
	 *     "exists": true,
	 *     "postKey": "5NUURN",
	 *     "indexed": "2011-01-08 00:38:22 UTC"
	 *   },
	 *   {
	 *     "exists": false
	 *   },
...
threeTapsSearchClient.prototype = {
	 ...
	 * @restStructure GET /search/search?[param]=[value]&[param2]=[value2]...
	 * @restUrlExample http://3taps.net/search/search?source=E_BAY&location=LAX

	 * @desc The search request creates a new search request.
	...
	'search': function(params, callback) {
		return this.client.request(this.path, 'search', params, null, function(results) {
			callback(results);
		});
	}
};
