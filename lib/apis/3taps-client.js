...
threeTapsClient.prototype = {
	agentId: null,
	authId: 'snyhvxpkt8smzra6ddqu4ar6',
	host: 'api.3taps.com',
	response: null,
	...
	request: function(path, method, getParams, postParams, callback) {
		...
		if (typeof require == 'function') {
			...
			if (getParams) {
				url += '?authID=' + this.authId + '&' + querystring.stringify(getParams);
			}

			if (postParams) {
				var post = 'authID=' + this.authId + '&' + querystring.stringify(postParams);
			} else {
				var post = '';
			}
...
threeTapsReferenceClient.prototype = {
	 ...
	 * @restUrlExample http://api.3taps.com/reference/location?authID=[your API key]

	 * @desc Returns the 3taps locations. Note that you can request a single location by passing in the location code: http://api.3taps.com/reference/location/NYC
	 ...
	 * @restUrlExample http://api.3taps.com/reference/category?authID=[your API key]

	 * @desc Returns the 3taps categories. Note that you can request a single category by passing in the category code: http://api.3taps.com/reference/category/VAUT
	 ...
	 * @restUrlExample http://api.3taps.com/reference/source?authID=[your API key]

	 * @desc Returns the 3taps sources. Note that you can request a single source by passing in the source code: http://api.3taps.com/reference/source/E_BAY
	 ...
	 * @restUrlExample http://api.3taps.com/reference/modified/source?authID=[your API key]
...
threeTapsPostingClient.prototype = {
	 ...
	 * @restUrlExample http://api.3taps.com/posting/get/X7J67W?authID=[your API key]
 ...
 * @class The Search API allows clients to query 3taps for data, and data about data.
	 ...
	 *		<td>heading</td>
	 *		<td>STRING</td>
	 *		<td>Postings must have this string in their heading to be found/processed. Supports "quoted phrases", -not, and OR.</td>
	 *	</tr>		
	 *	<tr>
	 *		<td>body</td>
	 *		<td>STRING</td>
	 *		<td>Postings must have this string in their body to be found/processed. Supports "quoted phrases", -not, and OR.</td>
	 *	</tr>
	 *	<tr>
	 *		<td>text</td>
	 *		<td>STRING</td>
	 *		<td>Postings must have this string in their body or heading to be found/processed. Supports "quoted phrases", -not, and OR.</td>
	 *	</tr>	
	 *	<tr>
	 *		<td>accountID</td>
	 *		<td>STRING</td>
	 ...
	 *		<td>indexedStart</td>
	 *		<td>DATE</td>
	 *		<td>Postings must have an indexed value after start to be found/processed.</td>
	 *	</tr>	
	 *	<tr>
	 *		<td>indexedEnd</td>
	 *		<td>DATE</td>
	 *		<td>Postings must have an indexed value before end to be found/processed.</td>
	 *	</tr>	
	 *	<tr>
	 *		<td>annotations</td>
	 *		<td>OBJECT</td>
...
threeTapsSearchClient.prototype = {
	 ...
	 * @restUrlExample http://api.3taps.com/search?source=E_BAY&location=LAX&authID=[your API key]
	 ...
	 * @param {STRING} sort The field to sort by. By default, searches are sorted by timestamp, descending. Other options include price, relevancy, and indexed.
	 * @param {STRING} reverse If set to "true", the sort order will be reversed (ascending instead of descending).
...
threeTapsNotificationsClient.prototype = {
   ...
   * @param {STRING} format defines how the notifications should be formatted.  The following formats are currently supported:
	 ...
	 *                 <tr>
	 *                     <td>push</td>
	 *                     <td>This format is intended for iPhone push notifications.  The notification includes the following information in a single line: subscription name; f notifications received on this subscription today; the heading of the post. 
	 *                 </tr>
 	 *                 <tr>
	 *                     <td>brief</td>
	 ...
	 *                  <tr>
	 *                      <td>atom</td>
	 *                      <td>This format is intended to send notifications to PubSubHubBub; it includes the entire content of the posting in Atom format. <a href="http://en.wikipedia.org/wiki/Atom_(standard)">More info on Atom</a>.</td>
	 *                  </tr>
	 *              </table>
	 *
