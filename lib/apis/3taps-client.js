...
threeTapsNotificationsClient.prototype = {
	 ...
	 * @param text {String} The text postings need to be sent to this firehose
   * @param src {String} The source code postings need to be sent to this firehose
   * @param loc {String} The location code postings need to be sent to this firehose
   * @param cat {String} The category code postings need to be sent to this firehose
   ...
   *
   * @param text {String} The text postings need to be sent to this subscriber
   * @param src {String} The source code postings need to be sent to this subscriber
   * @param loc {String} The location code postings need to be sent to this subscriber
   * @param cat {String} The category code postings need to be sent to this subscriber
   * @param expiration {Integer} The number of days to keep this subscription around for (default 7 days)
   * @param format {String} The format of notifications to be sent to this subscriber
   * @param email {String} The email address to send this notification to
   * @param jid {String} The XMPP JID to send this notification to
   * @param token {String} The iPhone Device Token to send this notification to    
	 * 
	 * <table>
	 *     <tr>
	 *         <td>text</td>
	 *         <td>If set, postings with this text in the body, header, or annotations will qualify for notification.</td>
	 *     </tr>
	 *     <tr>
	 *				<td>src</td>
	 *				<td>If set, postings with this source will qualify for notification.  This value should be a 5-letter source code (ex: E_BAY, CRAIG)</td>
	 *			</tr>
	 *			<tr>
	 *				<td>loc</td>
	 *				<td>If set, postings with this location will qualify for notification.  This value should be a 3-letter source code (ex: LAX, NYC)</td>
	 *     </tr>
	 *     <tr>
	 *				<td>cat<td>
	 *				<td>If set, postings with this location will qualify for notification.  This value should be a 4-letter category code (ex: VAUT, JOBS)</td>
	 *		</tr>
	 *		<tr>
	 *				<td>expiration</td>
	 *				<td>The number of days to keep this subscription alive.  The default is 7 days.</td>
	 *		</tr>
	 *     <tr>
	 *         <td>format</td>
	 ...
	 *     <tr>
	 *				<td>email</td>
	 *				<td>The email address that you would like notifications to be sent to.  Note that you should only supply one of email, jid, or token.</td>
	 *		</tr>
	 *		<tr>
	 *				<td>jid</td>
	 *				<td>The XMPP JID that you would like notifications to be sent to.  Note that you should only supply one of email, jid, or token.</td>
	 *		</tr>
	 *		<tr>
	 *				<td>token</td>
	 *				<td>The iPhone device token that you would like notifications to be sent to.  Note that you should only supply one of email, jid, or token.</td>
	 *     </tr>
	 * </table>
